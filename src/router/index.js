...
const routes = [{
    ...
    {
        path: '/wechat/dialogue/customer-info',
        name: "customer_info",
        components: {
            "subPage": resolve => require(["../components/wechat/customer_info.vue"], resolve)
        }
    },
    {
        path: '/wechat/dialogue/business-info',
        name: "business_info",
        components: {
            "subPage": resolve => require(["../components/wechat/business.vue"], resolve)
        }
    },
    // {
    ...
    { path: '/self', name: "个人信息", component: resolve => require(["../components/myself/self.vue"], resolve) },
    { path: '/selfMyQrcode', name: "我的二维码", component: resolve => require(["../components/myself/MyQrcode.vue"], resolve) },
    { path: '/header_pic', name: "设置头像", component: resolve => require(["../components/myself/header_pic.vue"], resolve) },
    { path: '/set_name', name: "设置名字", component: resolve => require(["../components/myself/set_name.vue"], resolve) },
    { path: '/set_sex', name: "设置性别", component: resolve => require(["../components/myself/set_sex.vue"], resolve) },
    { path: '/set_autograph', name: "设置个人签名", component: resolve => require(["../components/myself/set_autograph.vue"], resolve) },
    {
        path: '/self/album',
    ...
    },
    {
        path: '/tail',
        name: "业务跟踪",
        component: resolve => require(["../components/tail/index.vue"], resolve)
    },
    {
        path: '/statistics',
        name: "统计分析",
